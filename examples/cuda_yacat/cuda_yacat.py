...
async def main(args):
    package = await vm.repo(
		image_hash="eeb1d4e019ddc010e88140cbe7d9fdfc0d213173653222f10c5a5a33",
        min_mem_gib=4,
        min_cpu_threads=4,
        min_storage_gib=4,
...
# ./cuda_yacat.py --subnet-tag devnet-beta --mask '?a?a?a?a?a?a?a?a' --hash-type 0 --hash '5f4dcc3b5aa765d61d8327deb882cf99' --max-workers 2 --chunk-size 100000
