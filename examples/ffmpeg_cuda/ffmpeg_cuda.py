...
if __name__ == "__main__":
    parser = build_parser("Golem FFMPEG Cuda")
    ...
    parser.set_defaults(log_file=f"ffmpeg_cuda.log")
...
# ./ffmpeg_cuda.py --subnet-tag devnet-beta --gdriveid 1BNzHX9lYP7G4-ensM0o64z4d4asTK2nD
